    ...
    <div class="card-body px-5">
        ...
        <div class="flex-row"> 
                ...
                <div class="table-responsive w-50">
                    <table class="table table-borderless">          
                        <tbody>
                          ...
                          <tr>
                            <td>Tempat</td>
                            <td>: {{$apply->job->perusahaan->name}}, {{$apply->job->interview}}</td>   
                          </tr>         
                        </tbody>
                    </table>                          
                </div>
            ...
            @elseif($st == 9)
                ...
                @if($apply)                
                <a target="_blank" href="{{asset('storage/'.$apply->kontrak)}}" class="btn btn-primary btn-sm rounded-pill">Dokumen Kontrak</a>            
                @php $payment = $paymentDoc; @endphp
        ...
        @else         
            @php $payment = $paymentStudy; @endphp
            @include('participant.payment');             
        @endif  
    </div>
</div>
