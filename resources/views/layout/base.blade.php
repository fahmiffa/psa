    ...
    <div id="app">
        <div id="main" class="layout-horizontal">
            <header class="mb-5">
                <div class="header-top">
                    <div class="container">
                        <div class="logo d-flex align-items-center">
                            <a href="{{ route('home') }}" class="d-flex align-item-center">
                                <img src="{{ asset('logo.png') }}" style="height: 50px">
                                <h2 class="my-auto text-purple ms-3">{{ $title }}</h2>
                            </a>
                        </div>
                        <div class="header-top-right">
                            <div class="theme-toggle d-flex gap-2  align-items-center mt-2 d-none d-xl-flex">
                            ...
                            @if (Auth::user()->role == 'lpk')
                                <div class="dropdown mx-3">
                                    <a href="{{ route('log.lpk') }}">
                                        <i class='bi bi-bell bi-sub fs-4'></i>
                                        @if (activity())
                                            <span class="badge badge-notification badge-sm bg-danger"><i
                            ...
                            <div class="dropdown">
                                <a href="#" id="topbarUserDropdown"
                                    ...
                                    <div class="avatar avatar-md2">
                                        @if (auth()->user()->files)
                                            <img src="{{ asset('storage/' . auth()->user()->files->photo) }}"
                                                alt="Avatar">
                                        @else
                ...
                <nav class="main-navbar bg-purple">
                    @include('layout.nav')
                </nav>
            </header>
