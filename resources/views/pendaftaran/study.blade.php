  ...
  <div class="px-3">
      ...
      @for ($x = 0; $x < count($var); $x++)
        <div class="form-group row mb-3" id="master">                  
                <div class="col-3">
                    <input type="text" name="studied[]" value="{{$var[$x][0]}}" class="form-control" placeholder="Nama Pendidikan" required>
                </div>
                <div class="col-3">
                    <input type="month" name="first[]" class="form-control" value="{{$var[$x][1]}}" required>              
                </div>
                <div class="col-3">
                    <input type="month" name="end[]" class="form-control" value="{{$var[$x][2]}}" required>                  
                </div>            
        </div>
      @endfor
      @else
        <div class="form-group row mb-3" id="master">                  
                <div class="col-3">
                    <input type="text" name="studied[]" class="form-control" placeholder="Nama Pendidikan" required>
                </div>
                <div class="col-3">
