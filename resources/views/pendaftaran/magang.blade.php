...
<script>
    ...
    $('#add-item').on('click', function() {
        ...
        clonedDiv.append('<button class="btn btn-danger ms-3 mt-3" style="width:fit-content;height:fit-content" onclick="remove(this)"  type="button"><i class="bi bi-trash"></i></button>');  
