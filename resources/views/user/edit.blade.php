                        ...
                        <div class="px-3">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="lpk" value="{{ $da->lpk }}"
                                            class="form-control">
                                        @error('lpk')
                                            <div class='small text-danger text-left'>{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="look">
                                        ...
                                        <option value="2" @selected($da->look == '2')>Tidak Normal</option>
                                    </select>
                                    @error('look')
                                        <div class='small text-danger text-left'>{{ $message }}</div>
                                    @enderror
                            ...
                            @if ($da->study)
                                ...
                                @for ($x = 0; $x < count($var); $x++)
                                    <div class="form-group row mb-3" id="master-study">
                                        <div class="col-3">
                                            <input type="text" name="studied[]" value="{{ $var[$x][0] }}"
                                                class="form-control" placeholder="Nama Pendidikan">
                                        </div>
                                        <div class="col-3">
                                            <input type="month" name="firstStudy[]" class="form-control"
                                                value="{{ $var[$x][1] }}">
                                        </div>
                                        <div class="col-3">
                                            <input type="month" name="endStudy[]" class="form-control"
                                                value="{{ $var[$x][2] }}">
                                        </div>
                                    </div>
                                @endfor
                                    ...
                                    <div class="form-group row mb-3" id="master">
                                        <div class="col-4">
                                            <input type="text" name="job[]" class="form-control"
                                                value="{{ $var[$x][0] }}" placeholder="Nama Perusahaan">
                                        </div>
                                        <div class="col-2">
                                        ...
                                        <div class="col-3">
                                            <input type="text" name="var[]" value="{{ $var[$x][3] }}"
                                                class="form-control" placeholder="Pakerjaan">
                                        </div>
                                    </div>
                                @endfor
                            @else
                                    ...
                                    <div class="form-group row mb-3" id="master">
                                        <div class="col-4">
                                            <input type="text" name="lisensi[]" value="{{ $var[$x][0] }}"
                                                class="form-control" placeholder="Lisensi">
                                        </div>
                                        <div class="col-3">
