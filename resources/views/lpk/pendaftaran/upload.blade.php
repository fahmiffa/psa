<form action="{{route('lpk.next',['id'=>md5($user->id)])}}" method="post" enctype="multipart/form-data">                                                                       
  @csrf           
  <div class="px-3">
      ...
      <div class="form-group row mb-3">
        ...
        <div class="col-md-8">       
          ...
          @error('ktp')<div class='small text-danger text-left'>{{$message}}</div>@enderror
        </div>
    </div>
      ...
      <div class="form-group row mb-3">
        ...
        <div class="col-md-8">       
          ...
          @error('akte')<div class='small text-danger text-left'>{{$message}}</div>@enderror
        </div>
    </div>
    ...
    <div class="form-group row mb-3">
        ...
        <div class="col-md-8">       
          ...
          @error('kk')<div class='small text-danger text-left'>{{$message}}</div>@enderror
        </div>
    </div>
    ...
    <div class="form-group row mb-3">
        ...
        <div class="col-md-8">       
          ...
          @error('sks')<div class='small text-danger text-left'>{{$message}}</div>@enderror
        </div>
    </div>
    ...
    <div class="form-group row mb-3">
        ...
        <div class="col-md-8">       
          ...
          @error('covid')<div class='small text-danger text-left'>{{$message}}</div>@enderror
        </div>
    </div>
    ...
    <div class="form-group row mb-3">
        ...
        <div class="col-md-8">       
          ...
          @error('sd')<div class='small text-danger text-left'>{{$message}}</div>@enderror
        </div>
    </div>
    ...
    <div class="form-group row mb-3">
        ...
        <div class="col-md-8">       
          ...
          @error('smp')<div class='small text-danger text-left'>{{$message}}</div>@enderror
        </div>
    </div>
    ...
    <div class="form-group row mb-3">
        ...
        <div class="col-md-8">       
          ...
          @error('sma')<div class='small text-danger text-left'>{{$message}}</div>@enderror
        </div>
    </div>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-8">       
        ...
        @error('s1')<div class='small text-danger text-left'>{{$message}}</div>@enderror
      </div>
  </div>
    ...
    <div class="form-group row mb-3">
      ...
      <textarea class="form-control" rows="2" name="prom">{{old('prom')}}</textarea>              
        @error('prom')<div class='small text-danger text-left'>{{$message}}</div>@enderror
  </div>
