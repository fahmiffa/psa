                            ...
                            <div class="table-responsive w-50">
                                <table class="table table-borderless">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Tempat</td>
                                            <td>: {{ $head->apply->job->perusahaan->name }},
                                                {{ $head->apply->job->interview }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                    ...
                                    @foreach ($head->paid as $item)
                                        <tr>
                                            ...
                                            @else
                                                <td>{!! $item->status == 1
                                                    ? '<span class="badge bg-success">Success</span>'
                                                    : '<span class="badge bg-danger">On progress</span>' !!}</td>
                                            @endif
                                        </tr>
                                    @endforeach
                                </tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a target="_blank" href="{{ asset($item->file) }}"
                                                        class="btn btn-sm btn-dark"><i class="bi bi-files"></i></a>
                                                </td>
                                                </td>
                                            </tr>
                                        @endif
